          ...
          PopupMenuButton(itemBuilder: (ct) {
            return [
              PopupMenuItem(
                ...
                child: InkWell(
                  child: Text(
                      "${widget.userIndex.isBlocked?.value == true ? "Unblock user" : "Block user"}"),
                  onTap: () async {
                    Navigator.pop(ct);
                    showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return BeautifulAlertDialog(
                          text:
                              "Do you want to ${widget.userIndex.isBlocked?.value == true ? "Unblock" : "Block"} ${widget.userIndex.name} ?",
                          onYesTap: () async {
                            await queryCollectionDB("Users")
                                .doc(widget.userIndex.id)
                                .set(
                              {
                                "isBlocked": widget.userIndex.isBlocked?.value,
                              },
                              SetOptions(merge: true),
                            ).whenComplete(() {
                              Global().showInfoDialog(
                                  "${widget.userIndex.isBlocked?.value == false ? "Blocked" : "Unblocked"}");
                              widget.userIndex.isBlocked?.value =
                                  !widget.userIndex.isBlocked!.value;
                            });
                ...
                Expanded(
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Text("About"),
                      subtitle: Text(
                        widget.userIndex.editInfo?["about"] != null
